...
const OutgoingGoodsManagement = () => {
  ...
  const filteredGoods = goods
    ...
    .sort((a, b) => {
      if (sortOrder === "asc") {
        return a.dateShipped.localeCompare(b.dateShipped);
  ...
  return (
    <>
      ...
      <button onClick={toggleForm}>
        {showForm ? "Ẩn form" : "Thêm hàng xuất"}
      </button>
      {showForm && (
        <div className="employee-management">
          <form onSubmit={handleSubmit}>
            ...
            />
            <button type="submit">
              {currentGoods ? "Cập nhật" : "Thêm hàng xuất"}
            </button>
          </form>
        </div>
      )}
...
export default OutgoingGoodsManagement;
